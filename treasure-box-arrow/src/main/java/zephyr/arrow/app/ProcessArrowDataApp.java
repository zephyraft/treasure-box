 ...
 */
public class ProcessArrowDataApp {

    private static final Logger log = LoggerFactory.getLogger(ProcessArrowDataApp.class);
     ...
     */
    private static void processBatches(ArrowFileReader fileReader,
     ...
     */
    private static void aggregate(VectorSchemaRoot schemaRoot,
                           int[] selectedIndexes,
                           Map<ByteString, Long> perCityCount,
    ...
    private static IntArrayList filterOnLastName(VectorSchemaRoot schemaRoot) {
    ...
    private static IntArrayList filterOnAge(VectorSchemaRoot schemaRoot) {
    ...
    private static IntArrayList filterOnStreet(VectorSchemaRoot schemaRoot) {
     ...
     */
    private static IntArrayList intersection(IntList x, IntList y) {
        int indexX = 0;
        int indexY = 0;
