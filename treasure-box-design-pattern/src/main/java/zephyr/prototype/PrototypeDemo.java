...
import zephyr.prototype.framework.Manager;
 ...
 * @see zephyr.prototype.framework.Product
 * ConcretePrototype：具体的原型
 * @see zephyr.prototype.MessageBox
 * @see zephyr.prototype.UnderlinePen
 * Client：使用者，负责使用复制实例的方法生成新的实例
 * @see zephyr.prototype.framework.Manager
 *
