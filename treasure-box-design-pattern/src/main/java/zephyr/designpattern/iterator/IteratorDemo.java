...
import zephyr.designpattern.iterator.impl.ArrayBookShelf;
import zephyr.designpattern.iterator.impl.ArrayListBookShelf;

/**
 * 迭代器模式 - 4个角色
 * Iterator：迭代器，负责定义按顺序逐个遍历元素的接口
 * @see zephyr.designpattern.iterator.Iterator
 * ConcreteIterator： 具体的迭代器实现
 * @see zephyr.designpattern.iterator.impl.BookShelfIterator
 * @see zephyr.designpattern.iterator.impl.BookShelfReverseIterator
 * Aggregate：集合，负责定义创建迭代器角色的接口
 * @see zephyr.designpattern.iterator.Aggregate
 * @see zephyr.designpattern.iterator.BookShelfAggregate
 * ConcreteAggregate：具体的集合实现
 * @see zephyr.designpattern.iterator.impl.ArrayBookShelf
 * @see zephyr.designpattern.iterator.impl.ArrayListBookShelf
 *
