...
import zephyr.adapter.impl.PrintBannerDelegateAdapter;
import zephyr.adapter.impl.PrintBannerExtendAdapter;
 ...
 * 适配器模式 - 4个角色
 * Target：对象，负责定义所需的方法
 * @see zephyr.adapter.Print
 * Client：请求者，负责使用对象定义的方法
 * @see zephyr.adapter.AdapterDemo#main(String[])
 * Adaptee：被适配者
 * @see zephyr.adapter.Banner
 * Adapter：适配器
 * @see zephyr.adapter.impl.PrintBannerDelegateAdapter
 * @see zephyr.adapter.impl.PrintBannerExtendAdapter
 *
